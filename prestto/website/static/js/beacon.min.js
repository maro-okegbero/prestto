!function (e) {
    ...
    t.__esModule = !0;
    var i = n(1), o = n(2), a = n(3), c = n(4);
    !function () {
        function e(e) {
            var t = "";
            if (t = window.location.origin ? window.location.origin : window.location.protocol + "://" + window.location.host, e && "string" == typeof e) if (0 === e.indexOf("/")) t += e; else try {
                var n = new URL(e);
        ...
        function n() {
            ...
            if (!e) return !1;
            var t = parseInt(e[2], 10), n = navigator.connection;
        ...
        !function () {
            ...
            function d(r) {
                var o = l.timing, a = l.memory, c = r || e(), f = document.referrer || "", d = m[2] || m[1] || m[0],
                    p = {
                        memory: {},
                        timings: {},
                        resources: [],
                        ...
                        versions: {fl: g ? g.version : "", js: "2021.9.0", timings: 1},
                        pageloadId: v,
                        location: c
                    };
                if (void 0 == E) {
                ...
                if (p.documentWriteIntervention = n(), p.firstPaint = t("first-paint"), p.firstContentfulPaint = t("first-contentful-paint"), p.errorCount = window.__cfErrCount || 0, g && (p.siteToken = g.token, L = !0), "function" == typeof l.getEntriesByType) {
                    var h = l.getEntriesByType("resource"), w = 0, S = 0;
            ...
            var l = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance,
                ...
                v = c(), m = [], g = window.__cfBeacon ? window.__cfBeacon : {};
            if (!g || "single" !== g.load) {
                if (p) {
                    ...
                    if (y) try {
                        ...
                        if (h && "function" == typeof URLSearchParams) {
                            var w = new URLSearchParams(h.replace(/^[^\?]+\??/, "")), S = w.get("token");
                            S && (g.token = S);
                            var T = w.get("spa");
                            g.spa = null === T || "true" === T
                        }
                ...
                if (l && g && g.token) {
                    ...
                    var _ = {lcp: void 0, cls: void 0, fid: void 0}, O = function (e) {
                        ...
                        j = function (e) {
                            var t = function (e, t) {
                                n.resources = e, 0 != t && (n.bypassTiming = !0), g && (1 === g.r && (n.resources = []), k && 0 === t && (m.push({
                                    id: n.pageloadId,
                                    url: n.location
                                }), m.length > 3 && m.shift()), o.sendObjectBeacon("", n, function () {
                                }, !1, A), void 0 !== g.forward && void 0 !== g.forward.url && o.sendObjectBeacon("", n, function () {
                                }, !1, g.forward.url))
                            }, n = d(e);
                            if (n && g) {
                            ...
                            var t = f();
                            e || (t.resources = [], delete t.tempResources), g && o.sendObjectBeacon("", t, function () {
                            }, !0, A)
                        }, N = function () {
                            L = !0;
    ...
    function r(e, t, n, r, i) {
        ...
        var o = i || (t.siteToken && t.versions.fl ? "/cdn-cgi/rum?" + e : "/cdn-cgi/beacon/performance?" + e), a = !0;
        ...
        if (navigator && "function" == typeof navigator.sendBeacon && a && r) {
            t.st = 1;
            var s = JSON.stringify(t), u = {type: "application/json"};
            navigator.sendBeacon(o, new Blob([s], u))
        } else {
            t.st = 2;
            var s = JSON.stringify(t), f = new XMLHttpRequest;
    ...
    }, S = {passive: !0, capture: !0}, T = new Date, E = function (e, t) {
    ...
    function r(e, t, n) {
        ...
        if (a[6] = 15 & a[6] | 64, a[8] = 63 & a[8] | 128, t) for (var c = 0; c < 16; ++c) t[r + c] = a[c];
        return t || o(a)
    }
